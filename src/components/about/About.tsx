...
const About:React.FC = () => {
  const state = useStoreSelector((state) => state.globalReducer)
	return (
		<div className={`w-full flex flex-col 2xl:items-center ${state.darkMode ? "bg-gradient-to-t from-stone-950 to-amber-900 text-white" : "bg-gradient-to-t from-amber-500 to-amber-200 text-slate-900"}`}>
