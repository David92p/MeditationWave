...
const EngHome = {
    header: {
        ...
        second:"take 3 deep breaths …", 
        third: "count to 6 as you inhale", 
        fourth: "and up to 8 throwing out all the air,", 
        fifth: "repeat 4 times,",
        sixth: "relax for a few moments …",
        seventh: "… gently reopen your eyes",
        eighth: "and have a good day!"
    }
};

const ItaHome = {
    header: {
        first:"Chiudi gli occhi …", 
        second:"fai 3 respiri profondi …", 
        third: "conta fino a 6 inspirando", 
        fourth: "e fino a 8 buttando fuori tutta l'aria,", 
        fifth: "ripeti 4 volte,",
        sixth: "Rilassati qualche istante …",
        seventh: "… riapri dolcemente gli occhi",
        eighth: "e buona giornata!",
    }
}
