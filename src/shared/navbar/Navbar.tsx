        ...
        <div className="flex flex-col 2xl:flex-col-reverse h-2/3 w-[100%] 2xl:w-[50%]">
          ...
          <FontAwesomeIcon 
            ...
            onClick={() => onMenu()}
				...
				<button onClick={() => navigate("controller")} className="w-24 sm:w-28 h-8 sm:h-10 text-sm sm:text-lg bg-amber-800 hover:bg-amber-900 rounded-2xl text-white font-medium tracking-widest transition duration-300 ease-in-out shadow-xl mr-3 2xl:mr-7 2xl:mb-4">START</button>
			</div>
			<div id="container-link" className="flex flex-col 2xl:flex-row items-center 2xl:justify-around py-4 gap-4 w-[100%] h-[100%] absolute 2xl:static top-[-200px] bg-amber-700 bg-opacity-90 2xl:bg-transparent z-10">
